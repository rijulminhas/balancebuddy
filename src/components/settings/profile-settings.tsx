        ...
        <CardContent className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-medium">{format(user.createdAt, "MMMM d, yyyy")}</p>
            </div>
          </div>
          ...
          {user.emailVerified && (
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm font-medium">{format(user.emailVerified, "MMMM d, yyyy")}</p>
              </div>
            </div>
          )}
          ...
          {membership ? (
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <Badge variant="outline" className="text-xs capitalize">{membership.role === "owner" ? "Admin" : membership.role}</Badge>
              </div>
            </div>
          ) : (
            <div className="flex items-center gap-3">
