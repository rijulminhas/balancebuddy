    ...
    <div className="space-y-8">
      <div className="flex items-start justify-between">
        <div>
          ...
          <h1 className="text-4xl font-black tracking-tight">Hey, {firstName} 👋</h1>
        ...
        <Card className="border-primary/20 bg-primary/5">
          <CardContent className="flex items-center justify-between py-5 px-5">
            ...
            <Button
              ...
              size="sm"
              asChild
              className="rounded-xl font-bold border-primary/30 text-primary hover:bg-primary hover:text-primary-foreground"
            >
