  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-semibold tracking-tight">Room History</h1>
      ...
      {history.length === 0 ? (
        <Card className="border-dashed">
          <CardContent className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-sm font-medium">No room history yet</p>
        ...
        <ul className="space-y-3">
          {history.map((entry) => {
            const isSoftDeleted = entry.deletedByOwner;
            return (
              <li key={entry.id}>
                <Card>
